...
## Assets
- [ ] 128x128 icon (extension) ✅ `extension/assets/icon-128.png`
- [ ] Store icon 512x512 ✅ `store/assets/store-icon-512.png`
- [ ] Screenshots (at least 1) ✅ `store/assets/screenshot-1.png` ... `screenshot-4.png`
...
## Privacy
- [ ] Explain data collected (prompts + metadata) and why ✅ `store/privacy.md`
