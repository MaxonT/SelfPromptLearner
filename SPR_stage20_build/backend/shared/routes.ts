...
export const errorSchemas = {
  validation: z.object({ code: z.string().optional(), message: z.string(), requestId: z.string().optional(), field: z.string().optional(), }),
  notFound: z.object({ code: z.string().optional(), message: z.string(), requestId: z.string().optional(), }),
  internal: z.object({ code: z.string().optional(), message: z.string(), requestId: z.string().optional(), }),
};
...
export const api = {
  ...
  extension: {
    ...
    retryFailed: {
      method: 'POST' as const,
      path: '/api/extension/retry-failed',
